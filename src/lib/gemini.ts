...
export const chatWithAI = async (message: string, history: { role: string; content: string }[], userName: string = "Maliksaad", mode: string = "chat", modelName: string = "gemini-2.5-flash-preview-09-2025") => {
...
export const debateWithAI = async (message: string, history: { role: string; content: string }[], userName: string = "Maliksaad", modelName: string = "gemini-2.5-flash-preview-09-2025") => {
